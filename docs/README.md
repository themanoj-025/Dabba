# Dabba — Documentation Index

Single home for all Dabba documentation. Dabba is a restaurant intelligence
platform with an ML pipeline and data-processing flow.
