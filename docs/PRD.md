...
Top 3 (full list in RiskRegister.md):
...
|---|---|
| [TechSpec.md](TechSpec.md) | Architecture, stack |
| [AppFlow.md](AppFlow.md) | Dashboard/API flows |
| [Design.md](Design.md) | Design system |
| [Schema.md](Schema.md) | Data model |
| [ImplementationPlan.md](ImplementationPlan.md) | Build plan |
| [Tracker.md](Tracker.md) | Task status |
